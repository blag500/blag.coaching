#!/usr/bin/env node
// validate-flow-specs.cjs — advisory linter for User Flow Specs.
//
//   node validate-flow-specs.cjs <flow-specs-dir> [more dirs...]
//
...
if (!dirs.length) {
  console.error('Usage: node validate-flow-specs.cjs <flow-specs-dir> [more dirs...]');
  process.exit(2);
}
