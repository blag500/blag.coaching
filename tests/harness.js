...
export const TABLES = {
  ...
  bot_profile: [{
    user_id: USER_ID,
    /* Осем реда, колкото свиването наистина връща: при три списъкът не
       прелива и смачкването на разговорите не се вижда. */
    learned: 'не яде риба\nтренира сутрин\nне иска готвене над 15 минути\nпие кафе преди тренировка\nне понася млечни вечер\nготви в неделя за седмицата\nспи под седем часа в делник\nпредпочита пилешко пред риба',
    events_seen: 4,
    messages_seen: 8,
  }],
