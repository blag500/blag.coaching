...
export const DEFAULT_TRAINING_BLOCKS = [
  {
    ...
    exercises: [
      ...
      { id: '0-1', name: 'Наклонена лежанка с дъмбели', sets: '3', reps: '10–12'},
      { id: '0-2', name: 'Набирания с тежест',           sets: '4', reps: '6–8'  },
      { id: '0-3', name: 'Гребане с щанга',              sets: '3', reps: '8–10' },
      { id: '0-4', name: 'Curl с лост',                  sets: '3', reps: '10–12'},
      { id: '0-5', name: 'Трицепс с въже',               sets: '3', reps: '12–15'},
    ],
  },
  {
    id: '1',
    ...
    exercises: [
      ...
      { id: '1-1', name: 'Румънска мъртва тяга',  sets: '4', reps: '8–10' },
      { id: '1-2', name: 'Лег прес',              sets: '3', reps: '10–12'},
      { id: '1-3', name: 'Лег curl (машина)',     sets: '3', reps: '12–15'},
      { id: '1-4', name: 'Прасци прав',           sets: '4', reps: '15–20'},
    ],
  },
  {
    id: '2',
    ...
    exercises: [
      ...
      { id: '2-1', name: 'Кабелна флай',              sets: '3', reps: '12–15'},
      { id: '2-2', name: 'Лат пулдаун',               sets: '4', reps: '10–12'},
      { id: '2-3', name: 'Странично вдигане (кабел)', sets: '4', reps: '15–20'},
      { id: '2-4', name: 'Hammer curl',               sets: '3', reps: '12–15'},
    ],
  },
  {
    id: '3',
    ...
    exercises: [
      ...
      { id: '3-1', name: 'Bulgarian split squat',    sets: '3', reps: '10–12 (всеки крак)' },
      { id: '3-2', name: 'Leg extension (машина)',   sets: '3', reps: '12–15'              },
      { id: '3-3', name: 'Seated leg curl',          sets: '3', reps: '12–15'              },
      { id: '3-4', name: 'Прасци седнал',            sets: '4', reps: '15–20'              },
    ],
  },
  {
    id: '4',
    ...
    exercises: [
      ...
      { id: '4-1', name: 'Мобилити и стречинг',       sets: '1', reps: '15 мин'    },
    ],
  },
]
