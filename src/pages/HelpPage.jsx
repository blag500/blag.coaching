    ...
    articles: [
      {
        ...
        body: `Blag Coaching е персонализирано фитнес приложение, което работи като PWA (Progressive Web App) — инсталирате го на телефона си като нормално приложение, без да минавате през App Store.
      ...
      },
      {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'При регистрацията си ще бъдете попитани за удобно време, в което можем да се свържем с Вас.',
          },
        ],
      },
    ],
