...
/* Моделът го лепва и на същия ред, след точката — така белегът се появи на
   екрана на човека като част от отговора. */
проба('на същия ред', 'Пий повече вода. ИЗТОЧНИК: вода, тегло', 'Пий повече вода.', ['тегло'])
проба('без двоеточие', 'Х. ИЗТОЧНИК тегло', 'Х.', ['тегло'])
проба('с текст отдолу', 'Х.\nИЗТОЧНИК: тегло\nи още нещо', 'Х.', ['тегло'])
